...
function changeActivityWord(folder){
    var paragraph="";
    if(folder == "start"){
        paragraph = "「暑假好長好無聊喔，我可以做什麼？」、「聽說大學生都要自己選課，那是什麼？」、「我是玩咖，成大附近有什麼好玩的嗎？」、「好像有很多社團，看介紹好像也不太知道在幹嘛的欸？」如果你有上面這些疑問的話，來彰迎就對了！ 如果有什麼問題，也可以像學長姐提問喔！現在馬上報名，讓我們一起創造最美麗的開始吧！<br><br>\
        <div style='font-size: 23px;'><em>茶會資訊</em><br>\
        時間：8/25 下午兩點開始<br>\
        地點：茗人茶行<br>\
        地址：彰化縣員林市中山路二段90號(在員林火車站附近)<br>\
        因為店家有低消限制 所以請大家務必點一杯飲料阿~~~<br>\
        活動：109與110第一次的會面，主要是聊天講幹話聯繫感情，我們也會準備選課相關的資訊以及成大所必須知道的事情供你們服用，所以趕快填下你們的意見吧!!!!<br>\
        總召：<a href='https://www.facebook.com/profile.php?id=100000511003282&fref=ts'>陳柏熏</a><br>\
        文案：<a href='https://www.facebook.com/profile.php?id=100001742123840&fref=ts'>柯欣岳</a><br>\
        "
    }
        ...
        *成迎相關資訊之後會在彰友110版和各家版公布！*";
        ...
        paragraph = "顧名思義就是彰友會辦給心中有一個歌手夢的卡啦OK大賽，無論是想一展歌喉或是要上台刷存在感都很歡迎報名，不管你唱得如何台下總有一群死忠的彰友會夥伴會在台下幫你尖叫。在聆聽美妙好聲音的同時，會場旁邊會友零食跟飲料可以供你果腹，讓你耳朵跟肚子一起被填滿。最後由評審老師們討論後選出優勝者<del>，所有分數都是亂給的，就是一個來鬧的比賽不用太認真。</del>";
    }
    else if(folder == "tag"){
        paragraph = "這個遊戲是running man的進階版，不只要撕名牌，還多加了很多奇怪的規則，玩起來甚是刺激。除了撕名牌，我們還會安排Bonus獎品藏在校園各處，找到後可以為所屬隊伍加不少分。最後會有隨機關主根大魔王出現，用意就是要破壞遊戲平衡，至於怎麼破壞，來玩就知道了喔^_^";
    }
    else if(folder == "camp"){
